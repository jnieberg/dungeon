...
{
	console.log('Chromanin: write canvas');
    //var skel = "ch_canvas_tmp";
	//var ctx = ref.getContext('2d');
	//console.log('CTX: ' + ctx);
	var ref = document.getElementById(this.outcanvas);
	ref.width = this.layerSizeX;
	ref.height = this.layerSizeY;
	var ctx = ref.getContext('2d');
...
{
	console.log('Chromanin: sub plasma');
	var x, y;
	var offset, offset2;
	var corner = [];
	 corner[0] =new RGBA();
...
{
	console.log('Chromanin: sine plasma');
	amplitude/=256;
...
{
	console.log('Chromanin: perlin noise');
	 var r;
...
{
	console.log('Chromanin: particle');
	 var r, nx, ny;
	 var offset;
	f*=180;
	for (var y=0; y<this.layerSizeY; y++)
...
{
	console.log('Chromanin: color layer');
	var color= new RGBA();
...
{
	console.log('Chromanin: checker board layer');
	var col1=new RGBA();
	var col2=new RGBA();
...
{
	console.log('Chromanin: blobs layer');
...
{
	console.log('Chromanin: scale layer RGB');
	 var tr, tg, tb;
...
{
	console.log('Chromanin: scale layer HSV');
...
{
	console.log('Chromanin: adjust layer RGB');
	 var tr, tg, tb;
...
{
	console.log('Chromanin: adjust layer HSV');
	var th, ts, tv, tr, tg, tb;
...
{
	console.log('Chromanin: sine layer RGB');
	r*=Math.PI;
	g*=Math.PI;
	b*=Math.PI;
	for (var v=0; v<this.layerSizeX*this.layerSizeY; v++)
...
{
	console.log('Chromanin: equalize RGB');
...
{
	console.log('Chromanin: stretch RGB');
	var histogramR=new Array(256);
	var histogramG=new Array(256);
	var histogramB=new Array(256);
...
{
	console.log('Chromanin: invert layer');
	for (var v=0; v<this.layerSizeX*this.layerSizeY; v++)
	{
...
{
	console.log('Chromanin: matrix layer');
	var r, g, b;
	var offset;
...
{
	console.log('Chromanin: emboss layer');
...
{
	console.log('Chromanin: blur layer');
...
{
	console.log('Chromanin: edge H layer');
	var matrix=new Array(3);
	matrix[0]=new Array(3);
	matrix[1]=new Array(3);
	matrix[2]=new Array(3);
...
{
	console.log('Chromanin: edge V layer');
	var matrix=new Array(3);
	matrix[0]=new Array(3);
	matrix[1]=new Array(3);
	matrix[2]=new Array(3);
...
{
	console.log('Chromanin: sharpen layer');
	var matrix=new Array(3);
	matrix[0]=new Array(3);
	matrix[1]=new Array(3);
	matrix[2]=new Array(3);
...
{
	console.log('Chromanin: motion blur');
...
{
	console.log('Chromanin: make tilable');
...
{
	console.log('Chromanin: median layer');
...
{
	console.log('Chromanin: erode layer');
...
{
	console.log('Chromanin: dilate layer');
	var offset, offsetym1, offsetyp1, offsetxm1, offsetxp1;
	var r, g, b;
...
{
	console.log('Chromanin: sine distort');
	this.copyTemp(src);
	for (var y=0; y<this.layerSizeY; y++)
		for (var x=0; x<this.layerSizeX; x++)
...
{
	console.log('Chromanin: twirl layer');
...
{
	console.log('Chromanin: tile layer');
...
{
	console.log('Chromanin: noise distort');
	var dx, dy;
	this.copyTemp(src);
	this.seedValue=seed;
	radius=16-radius;
...
{
	console.log('Chromanin: move distort');
	this.copyTemp(src);
	for (var y=0; y<this.layerSizeY; y++)
		for (var x=0; x<this.layerSizeX; x++)
		{
...
{
	console.log('Chromanin: kaleid layer');
...
{
	console.log('Chromanin: tunnel distort');
...
{
	console.log('Chromanin: sculpture layer');
...
{
	console.log('Chromanin: map distort');
	var offset;
	var v;
...
{
	console.log('Chromanin: ADD layers');
	 var r, g, b;
...
{
	console.log('Chromanin: MUL layers');
	 var r, g, b, perc;
...
{
	console.log('Chromanin: XOR layers');
	 var r, g, b;
...
{
	console.log('Chromanin: AND layers');
	var r, g, b;
...
{
	console.log('Chromanin: OR layers');
	var r, g, b;
...
{
	console.log('Chromanin: rand combine layers');
	for (var v=0; v<this.layerSizeX*this.layerSizeY; v++)
	{
...
Chromanin.prototype.maxCombineLayers= function maxCombineLayers( src1,  src2,  dest,  perc1,  perc2)
{
	for (var v=0; v<this.layerSizeX*this.layerSizeY; v++)
	{
		console.log('Chromanin: max combine layers');
...
{
	console.log('Chromanin: min combine layers');
	for (var v=0; v<this.layerSizeX*this.layerSizeY; v++)
	{
...
Chromanin.prototype.cellMachine= function cellMachine(l,seed,rule, r, g, b)
{
	console.log('Chromanin: cell machine');
 var x,y,base_off,m ;
     var c = new RGBA();
